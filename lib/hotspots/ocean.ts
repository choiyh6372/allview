export type Hotspot = { id: number; type: string; x: number; y: number };

export const OCEAN_FLOOR_PLAN: Record<string, { image: string; hotspots: Hotspot[] }> = {
  ...
  ocean_kukdong: {
    ...
    hotspots: [
      ...
      { id: 95, type: "75", x: 44.7, y: 86.5 },
      { id: 96, type: "75", x: 55.9, y: 94.4 },
      { id: 97, type: "75", x: 67.2, y: 94.8 },
      { id: 98, type: "75", x: 81, y: 94.7 },
      { id: 99, type: "75", x: 91.4, y: 94.7 },
    ],
  },
  ocean_lotte: {
