...
const ITEMS: FeedItem[] = [
  {
    ...
    description: `<img src="${OG_IMAGE}" alt="AllView360(올뷰360) - 부산 강서구 부동산 통합 플랫폼" width="1200" height="630" /><p>AllView360(올뷰360)은 부산 강서구 명지오션시티, 명지국제신도시, 에코델타시티 아파트 실거래가, VR 투어, 부동산 뉴스를 한 곳에서 제공하는 통합 부동산 플랫폼입니다. 국토부 실거래가 데이터 기반의 정확한 시세 정보와 인터랙티브 지도를 확인하세요.</p>`,
    pubDate: new Date("2025-01-01"),
  },
  {
    title: "아파트 실거래가 지도 | AllView360 - 명지오션시티·명지국제신도시·에코델타시티",
...
<rss version="2.0">
  <channel>
    <title>AllView360(올뷰360) - 부산 강서구 부동산 통합 플랫폼</title>
