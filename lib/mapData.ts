...
export const APT_COMPLEXES: AptComplex[] = [
  ...
  // ── 지사동 ───────────────────────────────────────────────────────────────
  { id: "jisa_samjung",   name: "삼정그린코아",    apiName: "지사과학단지삼정그린코아", region: "other", regionName: "지사동", address: "부산 강서구 과학산단2로20번길 91",  lat: 35.15155, lng: 128.84087 },
  { id: "jisa_elysian",   name: "협성엘리시안",    apiName: "협성DS엘리시안",           region: "other", regionName: "지사동", address: "부산 강서구 과학산단로306번길 10", lat: 35.15007, lng: 128.83817 },
