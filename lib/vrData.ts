...
export const complexData: VRComplex[] = [
  ...
  { id: "ocean_kukdong", slug: "kukdong", name: "국동", regionId: "ocean", regionName: "오션시티",
  ...
  { id: "kukje_daebang2", slug: "daebang2", name: "대방2차", regionId: "kukje", regionName: "국제신도시",
    types: ["34a"] },
  { id: "kukje_eileen", slug: "eileen", name: "아일린", regionId: "kukje", regionName: "국제신도시",
    types: ["33a","33b"] },
  { id: "kukje_elife", slug: "elife", name: "이라이프", regionId: "kukje", regionName: "국제신도시",
    types: ["39c"] },
